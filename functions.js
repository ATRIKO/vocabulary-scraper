...
module.exports = function () {
    ...
    var allOfMySpecialCustomFunctions = {

        scrapeWord: function (currentWord) {
            ...
            request(URL, function (error, response, html) {
                ...
                switch (speechPart) {
                    ...
                    case "Substantiv":
                        this.processNoun($, setNum, word);
                        break;

                    case "Verb":
                        this.processVerb($, setNum, word);
                        break;

                    case "Adjektiv":
                        this.processAdj($, setNum, word);
                        break;

                    default:
                        this.skipIt(setNum, word);
                }
            });
    ...
    return allOfMySpecialCustomFunctions;
